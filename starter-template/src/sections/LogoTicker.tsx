...
const clients: Client[] = [
    {
        id: "imedi", type: "img", src: "/imedi-health-platform.png",
        label: "Regenerative Health", desc: "iMedi.health is a digital healthcare ecosystem developed in collaboration with Dr. Ashish Kalla, focusing on integrated medical services and personal branding.", href: "https://imedi.health"
    },
    {
    ...
    },
    {
        ...
        label: "Pharma", desc: "Medikold is a specialized healthcare vertical focused on pharmaceutical services and medical supply chains.", href: "https://medikold.com"
    },
    {
        id: "curestone", type: "img", src: "/cure-stone-clinic.png",
    ...
    },
    {
        ...
        label: "Professional", desc: "A specialist in General Medicine with a rich experience of over 13 years", href: "/blog/dr-ashish-kalla-regenerative-medicine"
    },
    {
        id: "gupta", type: "img", src: "/1650339213806-pvt6nrrseu7txrxqci6ph9v3zc7awzsjdx0be5vrno.jpg.webp",
        label: "Urologist", desc: "Dr Deepanshu Gupta is one of the top Urologist in Gurgaon/Delhi NCR. He is a dedicated and reputed  Urologist, Andrologist & Renal Transplant surgeon proficient in kidney stone treatment, Prostate Enlargement Surgery.", href: "/blog/dr-deepanshu-gupta-urologist-gurgaon"
    },
    {
        id: "goel", type: "img", src: "/Dr%20anshul.jpeg",
        label: "Orthopedic surgeon", desc: "Orthopedic surgeon, Spine Surgeon (Ortho), Joint Replacement Surgeon, Orthopedist 19 Years Experience Overall  (13 years as specialist)", href: "/blog/dr-anshul-goel-orthopedic-spine-surgeon"
    },
    {
        id: "a1agro", type: "img", src: "/a1-agro-india.png",
        label: "Agro Export", desc: "A1 Agro Industries is an international Basmati and Non-Basmati rice manufacturer and exporter based in Noida, Delhi NCR.", href: "https://a1agroindia.com"
    },
];
    ...
    return (
        <section className="py-24 bg-surface-container-lowest overflow-hidden border-y border-outline-variant/5">
            <div className="max-w-[1440px] mx-auto px-6 md:px-12 mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    <h2 className="text-primary uppercase text-xs font-bold tracking-[0.3em] font-headline mb-3">
                        Our Network
                    </h2>
                    <p className="font-headline font-bold text-white tracking-tighter" style={{ fontSize: "clamp(1.75rem, 3.5vw, 2.75rem)" }}>
                        ...
                        <div>
                            <div className="h-10 w-full flex items-center justify-start mb-6">
                                {client.type === "img" ? (
                                    <img
                                        src={client.src!}
                                        alt={`${client.label} — ${client.desc.split(".")[0]}`}
